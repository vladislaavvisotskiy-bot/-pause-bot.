...
ADMIN_ASK_TODAY_GARNISH = (
    ...
    "Или нажмите кнопку ниже, если сегодня гарнира на выбор нет вообще — "
    "клиенты при заказе «Сет стандарт» просто не увидят этот шаг."
)
ADMIN_GARNISH_SAVED = "Гарниры на сегодня сохранены ✓ Сегодня доступно: {list}"
ADMIN_GARNISH_CLEARED = "Ок, гарниров на сегодня нет — клиенты при заказе «Сет стандарт» не увидят этот шаг."
...
ADMIN_COMMANDS_LIST = (
    ...
    "/menu_survey — разослать разовый опрос о меню всем клиентам\n"
    "/menu_survey_results — результаты опроса о меню"
)
...
ADMIN_SURVEY_RESULTS_EMPTY = "Пока никто не прошёл опрос о меню."
ADMIN_SURVEY_RESULTS_HEADER = "📋 Опрос о меню — прошли {count} чел.:"
ADMIN_SURVEY_RESULT_ITEM = (
    "○ {name} (ID {tg_id}), {date}\n"
    "1) {a1}\n"
    "2) {a2}\n"
    "3) {a3}"
