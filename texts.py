...
ADMIN_ASK_TODAY_SETS = (
    "Какие сеты сегодня реально в меню? Напишите через запятую, техническими "
    "названиями из каталога — как в «Справочники» (например: Блюдо дня, Сет стандарт).\n"
    "Или нажмите кнопку ниже, чтобы показать клиентам вообще все сеты из каталога."
)
...
ADMIN_SETS_ALL_BTN = "Все сеты из каталога"
