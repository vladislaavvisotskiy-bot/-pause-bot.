...
ADMIN_ASK_TODAY_GARNISH = (
    ...
    "Если сегодня гарнира на выбор нет вообще — напишите «нет»: клиенты при заказе "
    "«Сет стандарт» просто не увидят этот шаг."
)
...
ADMIN_GARNISH_NONE_WORDS = {"нет", "не указываю", "не будет", "-", "—", "skip", "пропустить"}
...
ADMIN_BROADCASTS_OFF = (
    ...
    "об оплате (14:30), розыгрыш «Пауза в подарок».\n"
